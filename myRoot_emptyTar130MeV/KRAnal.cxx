...
cutg[3]=(TCutG*)fi->Get("cut_p10_vs_p12p13st_mod3")->Clone();
  cutg1[3]=(TCutG*)fi->Get("cut_am1_vs_am2_mod3")->Clone();
  //cutg2[3]=(TCutG*)fi->Get("cut_p10_vs_enProt_mod3")->Clone();
  ...
  cutg[10]=(TCutG*)fi->Get("cut_p10_vs_p12p13st_mod11")->Clone();
  cutg1[10]=(TCutG*)fi->Get("cut_am1_vs_am2_mod11")->Clone();
  cutg2[10]=(TCutG*)fi->Get("cut_p10_vs_enProt_mod11")->Clone();
...
//  TT.Branch("EventQuality",&EventQuality, "EventQuality/I" );
  ...
  for (Long_t event=0; event<nentries; event++) 
	...
	if(peak_mod[0]==0||peak_mod[0]==7||peak_mod[0]==3||peak_mod[0]==4||peak_mod[0]==11){
	  ...
	  if (peak_p22[0]==0 && peak_p23[0]==0 && peak_am2[0]<5)fl1=1;
