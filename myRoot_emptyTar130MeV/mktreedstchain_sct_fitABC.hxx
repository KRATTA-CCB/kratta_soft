...
//fit parameters  
  ...
  ClassDef(ASYFadcPeak,2)  //A peak segment
};
...
public:
  ...
  ClassDef(ASYEvent,2)  //Event structure
};
...
Double_t  getInterpolatedValue(Double_t x, Double_t * ArrayX, Double_t * ArrayY, Int_t ArraySize, Double_t &A_p0, Double_t &A_p1 , Double_t &A_p2 );
vector <Double_t> getPercents ( TH1D * A_hist, Double_t x0, Double_t xmax, Double_t ymax);
