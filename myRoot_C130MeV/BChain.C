...
TChain * fchain = new TChain("ntuple","KRAnal");

gSystem->Load("libKRRun.so");
printf("Library libKRRun.so has been loaded\n");
...
if(ClassName=="myClass"){
 ...
 size_t pos;
 //string mypath="/home/ciepal/Main/KRATTA/spall-2016-01/fit/";
 string mypath="";
 //size_t s1,s2;   
 string s1;
