...
TCanvas *c1=new TCanvas("coincid","coincid");
c1->Divide(2,2);
int licz22=0, licz11=0,licz21=0,licz12=0;
...
//   }
  ...
  int flag4 =0, flag14 =0, sum=0;



   for(int mod=0;mod<NDET;mod++){
     //if (mod==4 && ((amp[mod][0]>0 && amp[mod][1]>0 && amp[mod][2]>0) || (amp[mod][0]>0 && amp[mod][1]>0) ))flag4++; 
     //if (mod==14 && ((amp[mod][0]>0 && amp[mod][1]>0 && amp[mod][2]>0)|| (amp[mod][0]>0 && amp[mod][1]>0) ))flag14++; 
 
  if (mod==4 && (amp[mod][0]>0 && amp[mod][1]>0 && amp[mod][2]>0))flag4=3;
  if (mod==4 && (amp[mod][0]>0 && amp[mod][1]>0 && amp[mod][2]==0 ))flag4=2;
  if (mod==4 && (amp[mod][0]>0 && amp[mod][1]==0 && amp[mod][2]==0 ))flag4=1;
  
  if (mod==14 && (amp[mod][0]>0 && amp[mod][1]>0 && amp[mod][2]>0 ))flag14=3; 
  if (mod==14 && (amp[mod][0]>0 && amp[mod][1]>0 && amp[mod][2]==0))flag14=2; 
  if (mod==14 && (amp[mod][0]>0 && amp[mod][1]==0 && amp[mod][2]==0))flag14=1; 
  
  /*
 if (mod==5 && (amp[mod][1]>0 && amp[mod][2]>0))flag4=3;
  if (mod==5 && (amp[mod][1]>0 && amp[mod][2]==0 ))flag4=2;
  if (mod==5 && (amp[mod][0]>0 && amp[mod][1]==0 && amp[mod][2]==0 ))flag4=1;
  
  if (mod==13 && (amp[mod][1]>0 && amp[mod][2]>0 ))flag14=3; 
  if (mod==13 && (amp[mod][1]>0 && amp[mod][2]==0))flag14=2; 
  if (mod==13 && (amp[mod][0]>0 && amp[mod][1]==0 && amp[mod][2]==0))flag14=1; 
  */
  
  if(mod==14)cout<<i_nevent<<" "<<e_trigg<<" "<<mod<<" "<<amp[mod][0]<<" "<< amp[mod][1]<<" "<< amp[mod][2]<<endl; 
  
  
  }
   sum=flag4+flag14;    
//if (flag4>1 && flag14>1)cout<<i_nevent<<" "<<e_trigg<<" "<<flag4<<" "<<flag14<<endl;
e_trigg=0;
//    addr_mod += i_EVENT_SIZE;
//    printf("addr_mod %d\n",addr_mod);
//    if(addr_mod<i_EVENT_SIZE0-1) goto labmod;
  ...
  //if(flag4==2||flag)hamp01[mod]->Fill(amp[mod][1],amp[mod][0]);


 if (flag4==3 && flag14==3){
  hamp12[5]->Fill(amp[5][2],amp[5][1]);
  hamp12[13]->Fill(amp[13][2],amp[13][1]);
licz22++;

}

 if (flag4==2 && flag14==3){
  hamp01[5]->Fill(amp[5][1],amp[5][0]);
  hamp12[13]->Fill(amp[13][2],amp[13][1]);
licz12++;
 ...
 if (flag4==3 && flag14==2){
  hamp01[13]->Fill(amp[13][1],amp[13][0]);
  hamp12[5]->Fill(amp[5][2],amp[5][1]);
licz21++;
...
//if ((flag4==3 && flag14==3)||(flag4==2 && flag14==3)||(flag4==3 && flag14==2))
 //hamp12[mod]->Fill(amp[mod][2],amp[mod][1]);
...
cout<<licz11<<" "<<licz12<<" "<<licz21<<" "<<licz22<<endl;
